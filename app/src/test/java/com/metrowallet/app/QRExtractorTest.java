...
import static com.metrowallet.app.entity.EIP681Type.OTHER;
...
public class QRExtractorTest {
    ...
    public void parseQRURLTest() {
        ...
        result = parser.parse("https://www.metrowallet.com");
        System.out.println(result.getAddress());
        assertTrue(result.type == EIP681Type.URL);

        result = parser.parse("http://www.metrowallet.com");
        System.out.println(result.getAddress());
        assertTrue(result.type == EIP681Type.URL);
    }
}