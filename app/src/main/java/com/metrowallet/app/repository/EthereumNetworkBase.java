...
import com.metrowallet.token.entity.ChainSpec;
...
{
    private static final String DEFAULT_HOMEPAGE = "https://metrowallet.com/browser/";
    /* constructing URLs from BuildConfig. In the below area you will see hardcoded key like da3717...
       These hardcoded keys are fallbacks used by MetroWallet forks.
    ...
    //Note that MetroWallet now uses a double node configuration. See class AWHttpService comment 'try primary node'.
