...
import static com.metrowallet.token.tools.TokenDefinition.TOKENSCRIPT_ERROR;
...
public class Web3TokenView extends WebView
{
    ...
    private void init() {
        ...
        webSettings.setUserAgentString(webSettings.getUserAgentString()
                                               + "MetroWallet(Platform=Android&AppVersion=" + BuildConfig.VERSION_NAME + ")");
        ...
        addJavascriptInterface(new TokenScriptCallbackInterface(
                ...
                innerOnSetValuesListener), "metro");
