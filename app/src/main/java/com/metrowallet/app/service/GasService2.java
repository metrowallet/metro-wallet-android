...
import com.metrowallet.app.entity.GasPriceSpread;
...
import com.metrowallet.app.repository.entity.RealmGasSpread;
...
import static com.metrowallet.app.C.DEFAULT_GAS_LIMIT_FOR_NONFUNGIBLE_TOKENS;
import static com.metrowallet.app.C.GAS_LIMIT_CONTRACT;
import static com.metrowallet.app.C.GAS_LIMIT_DEFAULT;
import static com.metrowallet.app.C.GAS_LIMIT_MIN;
import static com.metrowallet.app.repository.EthereumNetworkBase.ARTIS_TAU1_ID;
...
import static com.metrowallet.app.repository.TokensRealmSource.TICKER_DB;
...
{
    private final static String GAS_NOW_API = "https://www.gasnow.org/api/v3/gas/price?utm_source=MetroWallet";
