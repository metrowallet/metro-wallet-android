...
import com.metrowallet.app.entity.walletconnect.WCRequest;
import com.metrowallet.app.repository.SignRecord;
import com.metrowallet.app.service.GasService2;
import com.metrowallet.app.ui.widget.entity.ActionSheetCallback;
import com.metrowallet.app.viewmodel.WalletConnectViewModel;
import com.metrowallet.app.viewmodel.WalletConnectViewModelFactory;
import com.metrowallet.app.walletconnect.WCClient;
import com.metrowallet.app.walletconnect.WCSession;
...
public class WalletConnectActivity extends BaseActivity implements ActionSheetCallback, StandardFunctionInterface
{
    ...
    private void initWalletConnectPeerMeta()
    {
        ...
        String url = "https://www.metrowallet.com";
    ...
    private ActionSheetDialog generateTransactionRequest(Web3Transaction w3Tx, int chainId)
    {
        ...
        try
        {
                    ...
                    || (!w3Tx.recipient.equals(Address.EMPTY) && (w3Tx.payload != null || w3Tx.value != null))) // Raw or Function TX
            {
                ...
                viewModel.calculateGasEstimate(viewModel.getWallet(), com.metrowallet.token.tools.Numeric.hexStringToByteArray(w3Tx.payload),
