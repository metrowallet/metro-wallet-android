...
import com.metrowallet.app.entity.HomeCommsInterface;
import com.metrowallet.app.entity.HomeReceiver;
...
import com.metrowallet.app.ui.widget.entity.ScrollControlViewPager;
import com.metrowallet.app.util.LocaleUtils;
import com.metrowallet.app.util.RootUtil;
import com.metrowallet.app.util.Utils;
import com.metrowallet.app.viewmodel.BaseNavigationActivity;
...
import com.metrowallet.app.widget.AWalletConfirmationDialog;
...
import static com.metrowallet.app.C.CHANGED_LOCALE;
import static com.metrowallet.app.entity.WalletPage.ACTIVITY;
import static com.metrowallet.app.entity.WalletPage.DAPP_BROWSER;
import static com.metrowallet.app.entity.WalletPage.SETTINGS;
import static com.metrowallet.app.entity.WalletPage.WALLET;
        ...
        FragmentMessenger, Runnable, SignAuthenticationCallback, LifecycleObserver
{
    ...
    {
        Log.d("LIFE", "MetroWallet into foreground");
    ...
    {
        Log.d("LIFE", "MetroWallet into background");
    ...
    private void checkWarnings()
    {
        if (updatePrompt)
        {
            ...
            if (warns < 3)
            {
                ...
                cDialog.setTitle(R.string.metrowallet_update);
                cDialog.setCancelable(true);
                cDialog.setSmallText("Using an old version of Metrowallet. Please update from the Play Store or Metrowallet website.");
