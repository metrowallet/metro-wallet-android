...
import static com.metrowallet.app.C.CHANGE_CURRENCY;
import static com.metrowallet.app.C.EXTRA_CURRENCY;
import static com.metrowallet.app.C.EXTRA_LOCALE;
...
public class AdvancedSettingsActivity extends BaseActivity {
        ...
        switch (requestCode)
        {
            case HomeActivity.RC_ASSET_EXTERNAL_WRITE_PERM:
                if (viewModel.createDirectory())
                {
                    ...
                    showMetroWalletDirectoryConfirmation();
    ...
    private void showMetroWalletDirectoryConfirmation() {
