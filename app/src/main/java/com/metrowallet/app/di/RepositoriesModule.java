...
import com.metrowallet.app.repository.TransactionLocalSource;
import com.metrowallet.app.repository.TransactionRepository;
...
import com.metrowallet.app.repository.WalletDataRealmSource;
import com.metrowallet.app.repository.WalletRepository;
import com.metrowallet.app.repository.WalletRepositoryType;
import com.metrowallet.app.service.AccountKeystoreService;
...
import com.metrowallet.app.service.KeystoreAccountService;
import com.metrowallet.app.service.MarketQueueService;
import com.metrowallet.app.service.NotificationService;
...
import com.metrowallet.app.service.TransactionsNetworkClient;
import com.metrowallet.app.service.TransactionsNetworkClientType;
...
public class RepositoriesModule {
	...
	@Singleton
	@Provides
    MetroWalletService provideFeemasterService(OkHttpClient okHttpClient,
                                               TransactionRepositoryType transactionRepository,
                                               Gson gson) {
		return new MetroWalletService(okHttpClient, transactionRepository, gson);
	}
    ...
    AssetDefinitionService provideAssetDefinitionService(OkHttpClient okHttpClient, Context ctx, NotificationService notificationService, RealmManager realmManager,
														 ...
														 TokenLocalSource tls, TransactionRepositoryType trt, MetroWalletService metroService) {
		return new AssetDefinitionService(okHttpClient, ctx, notificationService, realmManager, ethereumNetworkRepository, tokensService, tls, trt, metroService);
	}
