...
public class HomeViewModel extends BaseViewModel {
    ...
    public static final String ALPHAWALLET_DIR = "MetroWallet";
    public static final String ALPHAWALLET_FILE_URL = "https://1x.metrowallet.com/dl/latest.apk";
    ...
    private void downloadAPK(String version, Context ctx) {
        ...
        File testFile = new File(destination, "MetroWallet-" + version + ".apk");
        if (testFile.exists()) {
            testFile.delete();
        }
        ...
        request.setDescription(ctx.getString(R.string.metrowallet_update) + " " + version);
