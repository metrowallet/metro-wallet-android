...
import com.metrowallet.token.util.DateTime;
import com.metrowallet.token.util.DateTimeFactory;
        ...
        switch (getAs())
        {
            ...
            case Mapping:
                ...
                else
                {
                    ...
                    //refer to 'MetroWallet meetup indices' where 'Match' mapping is null but for FIFA is not.
