package com.metrowallet.token.web.Service;

import static com.metrowallet.token.entity.MagicLinkInfo.ARTIS_SIGMA1_NETWORK_ID;
import static com.metrowallet.token.entity.MagicLinkInfo.ARTIS_TAU1_NETWORK_ID;
import static com.metrowallet.token.entity.MagicLinkInfo.CLASSIC_NETWORK_ID;
import static com.metrowallet.token.entity.MagicLinkInfo.GOERLI_NETWORK_ID;
import static com.metrowallet.token.entity.MagicLinkInfo.KOVAN_NETWORK_ID;
import static com.metrowallet.token.entity.MagicLinkInfo.MAINNET_NETWORK_ID;
import static com.metrowallet.token.entity.MagicLinkInfo.POA_NETWORK_ID;
import static com.metrowallet.token.entity.MagicLinkInfo.RINKEBY_NETWORK_ID;
import static com.metrowallet.token.entity.MagicLinkInfo.ROPSTEN_NETWORK_ID;
import static com.metrowallet.token.entity.MagicLinkInfo.SOKOL_NETWORK_ID;
import static com.metrowallet.token.entity.MagicLinkInfo.XDAI_NETWORK_ID;
import static com.metrowallet.token.web.AppSiteController.getInfuraKey;
