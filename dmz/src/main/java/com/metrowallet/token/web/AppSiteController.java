package com.metrowallet.token.web;
...
import com.metrowallet.token.entity.MagicLinkInfo;
import com.metrowallet.token.entity.NonFungibleToken;
import com.metrowallet.token.entity.SalesOrderMalformed;
import com.metrowallet.token.entity.XMLDsigVerificationResult;
...
import com.metrowallet.token.tools.XMLDSigVerifier;
import com.metrowallet.token.web.Ethereum.TokenscriptFunction;
import com.metrowallet.token.web.Ethereum.TransactionHandler;
import com.metrowallet.token.web.Service.CryptoFunctions;
import static com.metrowallet.token.tools.Convert.getEthString;
import static com.metrowallet.token.tools.ParseMagicLink.normal;
import static com.metrowallet.token.web.Ethereum.TokenscriptFunction.ZERO_ADDRESS;
...
public class AppSiteController implements AttributeInterface
{
    ...
    private static final String appleAssociationConfig = "{\n" +
            ...
            "    \"details\": [\n" +
            "      {\n" +
            "        \"appID\": \"LRAW5PL536.com.stormbird.metrowallet\",\n" +
            "        \"paths\": [ \"*\" ]\n" +
            "      }\n" +
            "    ]\n" +
            "  }\n" +
    ...
    public RedirectView home(RedirectAttributes attributes){
        return new RedirectView("http://metrowallet.com");
    }
